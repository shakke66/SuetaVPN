...
export const ru = {
  ...
  subscriptions: {
    ...
    term: {
      inactive: 'Неактивно', warn: 'пора продлить', crit: 'продлите сейчас', off: 'доступ отключён',
    },
    card: {
  ...
  support: {
    ...
    create: { title: 'Новое обращение', subjectLabel: 'Тема', subjectPlaceholder: 'Кратко опишите вопрос', messageLabel: 'Сообщение', messagePlaceholder: 'Расскажите подробнее', attachmentLabel: 'Прикрепить файл', attachmentChoose: 'Выбрать файл', attachmentEmpty: 'Файл не выбран', submit: 'Создать обращение', success: 'Обращение создано', subjectRequired: 'Укажите тему', messageRequired: 'Введите сообщение' },
...
export const en = {
  ...
  support: {
    ...
    create: { title: 'New ticket', subjectLabel: 'Subject', subjectPlaceholder: 'Briefly describe your question', messageLabel: 'Message', messagePlaceholder: 'Tell us more', attachmentLabel: 'Attach file', attachmentChoose: 'Choose file', attachmentEmpty: 'No file chosen', submit: 'Create ticket', success: 'Ticket created', subjectRequired: 'Enter a subject', messageRequired: 'Enter a message' },
